...
namespace QuanLyBanHang02.IdentityServer
{
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> Apis =>
            new ApiResource[]
            {
                new ApiResource("api.QLNuocHoa", "QLNuocHoa API")
            };
        ...
        new ApiScope[]
        {
                new ApiScope("api.QLNuocHoa", "QLNuocHoa API")
        };
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client
                {
                    ...
                    RedirectUris =           { "https://localhost:7191/swagger/oauth2-redirect.html" }, // chuyển hướng
                    PostLogoutRedirectUris = { "https://localhost:7191/swagger/oauth2-redirect.html" },// chuyển hướng đăng xuất
                    AllowedCorsOrigins =     { "https://localhost:7191" }, // cho phép nguồn gốc cores
